...
- [JaCoCo Maven Plugin](https://www.jacoco.org/jacoco/trunk/doc/maven.html) for coverage checks
- [Trivy](https://github.com/aquasecurity/trivy) for vulnerability scanning
- [OWASP ZAP Baseline Scan](https://www.zaproxy.org/docs/docker/baseline-scan/) for DAST
