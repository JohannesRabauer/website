---
title: "Spec-Driven Development and the AI Unified Process: Building a Vaadin App End-to-End"
date: "2026-05-14"
...
One thing we discovered along the way: we did not need the [Vaadin Claude Plugin](https://github.com/vaadin/claude-plugin) at all. The archetype plus the marketplace skills gave Claude Code enough context to handle Vaadin-specific output correctly.
