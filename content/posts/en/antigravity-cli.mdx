...
After the stream, I spent a few more minutes prompting — and the app finally ran.

![Antigravity Marathon Demo App](/blog/antigravity-marathon.png)

If you want to see the result, check out the [antigravity-marathon-demo](https://github.com/JohannesRabauer/antigravity-marathon-demo) repository.
