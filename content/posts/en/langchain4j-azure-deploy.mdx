...
While code generated in the background, Brian toured Azure AI Foundry's model catalog. Its benchmark leaderboard compared quality, safety, and cost across roughly 11,000 available models. By then, **Sonnet 5** had quietly become my favorite model to work with.
...
Scout and Copilot did not fail the demo. The app was simply too large for a two-hour stream. Choosing a smaller target next time is the lesson, not a workaround. Brian had expected that risk.
