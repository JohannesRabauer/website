...
Nach dem Stream habe ich noch ein paar Minuten weiter geprompted — und die App hat schließlich funktioniert.

![Antigravity Marathon Demo App](/blog/antigravity-marathon.png)

Wer das Ergebnis sehen möchte, findet es im Repository [antigravity-marathon-demo](https://github.com/JohannesRabauer/antigravity-marathon-demo).
