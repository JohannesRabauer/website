...
Die Modellkonfiguration ging schnell. langchain4js Abstraktion hielt, und ein echtes Azure-AI-Foundry-Modell war nach wenigen Minuten live. Trotzdem braucht ein KI-gestütztes Deployment Aufsicht. Bei jedem Fehler musste ein Mensch das Symptom erkennen, den Plan korrigieren oder den Code reparieren. Brian arbeitete nach dem Stream weiter und veröffentlichte das **[fertige, funktionierende Beispiel](https://github.com/bbenz/20260827-jug-oberpfalz-demo)**. Das zählt mehr als die Erfolgsmeldung eines Agenten.

## Nützliche Links

- [Brians fertiges Beispiel für die Support-Ticket-Analyse](https://github.com/bbenz/20260827-jug-oberpfalz-demo), mit lokaler Einrichtung, Kubernetes-Manifesten und dem AKS-Deployment-Workflow
