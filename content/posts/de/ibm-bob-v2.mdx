...
<div className="mdx-image-compact">
  <ZoomableImage
    ...
    caption="Das Willkommensbanner der Bob Shell, läuft vorerst noch auf der v1-Loop."
  />
</div>
...
<ZoomableImage
  ...
  alt="Bob's Habit Tracker in Betrieb, mit der Habit-Liste inklusive Streaks"
  caption="Der fertige Habit-Tracker: farbcodierte Habits, Emojis und Streak-Zähler."
/>
