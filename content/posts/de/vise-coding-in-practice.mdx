...
- [Slides](https://docs.google.com/presentation/d/1G-0khMxuvVTvgWZMT4LAMyMnSGYFIAooDaK8o7GUMoI/edit?usp=sharing): Session-Folien
- [Vise-Coding-Artikel von David Farago](https://www.linkedin.com/pulse/vise-coding-david-farago-1k5ce/): Originalartikel zu Vise Coding
...
- [GitHub Spec Kit](https://github.com/github/spec-kit): Toolkit für Spezifikations-Workflows
- [Kiro](https://kiro.dev/): Vorschau auf Spec-Driven-IDE
- [Demo-2-Repository, Resilience4J](https://github.com/resilience4j/resilience4j): Resilience4J-Demo-Repository
- [Docker Sandboxes](https://www.docker.com/products/docker-sandboxes/): Containerisierte Sandbox-Umgebungen
- [Grith](https://grith.ai/): KI-Sandbox-Plattform
- [Sprites](https://sprites.dev/): Cloud-Sandbox-Tooling
- [Matchlock](https://github.com/jingkaihe/matchlock): Sandboxing für Coding-Agenten
- [Firecracker](https://firecracker-microvm.github.io/): Leichte MicroVM-Isolation
- [Modal Sandboxes](https://modal.com/docs/guide/sandboxes): Ephemere Code-Sandboxes
- [Daytona](https://www.daytona.io/): Sichere Dev-Sandboxes
- [AI4JVM](https://ai4jvm.com/): KI für JVM-Engineering
- [Memory Upgrade für KI-Agenten, beads](https://github.com/gastownhall/beads): Persistente Agent-Memory-Experimente
- [Avoid Losing Work with Jujutsu (jj) for AI Coding Agents](https://www.panozzaj.com/blog/2025/11/22/avoid-losing-work-with-jujutsu-jj-for-ai-coding-agents/): jj-Workflows für Agenten
- [jj-benchmark](https://tabbyml.github.io/jj-benchmark/): jj-Benchmark-Ergebnisse
- [Jujutsu](https://www.jj-vcs.dev/latest/): Modernes Versionsmanagement
- [AGENTS.md-Template](https://github.com/JohannesRabauer/agent-template/blob/master/AGENTS.md): Template für Betriebsmodell
