...
<div className="mdx-image-compact">
  <ZoomableImage
    ...
    alt="biomelabs Kanban-Board: links die registrierten Projekte, rechts fünf Spalten mit Worktree-Karten, eine Scaffolding-Karte steht in der Spalte PR In Review"
  />
</div>
...
<div className="mdx-image-compact">
  <ZoomableImage
    ...
    alt="biomelab unter Windows mit der Fehlermeldung invalid reference: reference not found beim Versuch, die Scaffolding-Worktree in einem Repo ohne initialen Commit zu erstellen"
  />
</div>
